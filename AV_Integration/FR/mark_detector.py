...
class MarkDetector:
    ...
    def __init__(self, path, mark_model='assets/frozen_inference_graph.pb'):
        """Initialization"""
        # A face detector is required for mark detection.
        dnn_proto_text = path + "/assets/deploy.prototxt"
        dnn_model = path + "/assets/res10_300x300_ssd_iter_140000.caffemodel"
